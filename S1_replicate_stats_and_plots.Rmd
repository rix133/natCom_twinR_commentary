...
library(ggplot2)
#some nice colors
bc <- c("azure3","purple4", "black", "navy", "darkgoldenrod2", "springgreen3", "gray")
...
fig2_ext_orig <- ggplot() +  
  geom_line(data=fig2_EE_plot_data,
    ...
    labs(subtitle = paste0("All births, ", infoTxt),
...
fig2_ext_orig <- ggplot() +  
  geom_line(data=fig2_EE_plot_data_nl,
    ...
    labs(subtitle = paste0("Without last birth, ", infoTxt),
         y="Per-birth twin. prob.",
         x="Maternal total births")
...
fig2a <- draw_fig_4C(fig4C_orig_plot_data) + 
  labs(subtitle = "(A) 9 W-European pop., all births") 

fig2b <- draw_fig_4C(fig4C_EE_plot_data) + 
  labs(subtitle = "(B) Estonia, all births") 

fig2c <- draw_fig_4C(fig4C_orig_nl_plot_data, y_lims = c(0.01, 0.035)) + 
  labs(subtitle = "(C) 9 W-European pop., without last birth") 
  
fig2d <- draw_fig_4C(fig4C_EE_nl_plot_data,y_lims = c(0.01, 0.035)) + 
  labs(subtitle = "(D) Estonia, without last birth") 
